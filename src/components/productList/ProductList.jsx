    ...
    <div className="productList">
      <div className="product_list_item" >
        <div className="productList_info">
          ...
          <button type='submit' className="product_list_item_btn" onClick={() => addItem(product)}>Add to cart</button>
        </div>
        <img src={product.image} alt="rasmlar" className="product_list_item_img" width="400px" height="300px"  />
      </div>
      {product.title}
    </div>
  );
